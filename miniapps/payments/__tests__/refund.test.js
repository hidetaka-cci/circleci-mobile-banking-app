...
describe('calculateRefund', () => {
  ...
  test('partial refund rounds down on odd totalCents', () => {
    const odd = { amountCents: 999, feeCents: 0, totalCents: 999, card: '•••• 0001' };
    expect(calculateRefund(odd, 'partial')).toBe(499);
  });
});
